...
const listCarsRoutes = require('./Routes/listCarsRoutes'); //Importei o listCarsRoutes onde fica as API endpoints.
...
require('./models/Log'); //Carregar a estrutura log definido no banco de dados
